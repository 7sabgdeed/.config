...
hl.config({
    misc = {
        force_default_wallpaper = 0,    -- Set to 0 or 1 to disable the anime ggege wallpapers
...
local win = "SUPER" -- Sets "Windows" key as main modifier
local win_shift = "SUPER + SHIFT"
local win_dot = "SUPER + period"
local ctrl_shift = "CTRL + SHIFT"
local ctrl_alt_shift = "CTRL + ALT + SHIFT"
local PRTSC_key = "PRINT" 
...
hl.bind(ctrl_shift  .. " + S", hl.dsp.exec_cmd(syncThing_browser))
hl.bind(win .. " + R", hl.dsp.exec_cmd(launcher))
...
-- hl.bind(win_shift .. " + F", hl.dsp.window.float({ action = "toggle" }))
hl.bind(win.. " + F", hl.dsp.window.float({ action = "toggle" }))
-- hl.bind(win .. " + R", hl.dsp.exec_cmd(menu))
hl.bind(win .. " + P", hl.dsp.window.pseudo())
-- hl.bind(win .. " + J", hl.dsp.layout("togglesplit"))    -- dwindle only
...
hl.bind(ctrl_shift .. " + h",  hl.dsp.window.move({ direction = "left" }))
hl.bind(ctrl_shift .. " + l", hl.dsp.window.move({ direction = "right" }))
hl.bind(ctrl_shift .. " + k",    hl.dsp.window.move({ direction = "up" }))
hl.bind(ctrl_shift .. " + j",  hl.dsp.window.move({ direction = "down" }))
...
hl.bind(win .. " + SHIFT + S", hl.dsp.window.move({ workspace = "special:magic" }))
